...
call ../../yii migrate/down --migrationPath=@themes/shop/migrations --interactive=0
call ../../yii migrate/down --migrationPath=@cmsgears/module-shop/migrations --interactive=0
call ../../yii migrate/down --migrationPath=@cmsgears/module-shop/migrations --interactive=0
...
call ../../yii migrate/down --migrationPath=@cmsgears/module-cart/migrations --interactive=0
call ../../yii migrate/down --migrationPath=@cmsgears/module-cart/migrations --interactive=0
call ../../yii migrate/down --migrationPath=@cmsgears/module-cart/migrations --interactive=0
call ../../yii migrate/down --migrationPath=@cmsgears/module-payment/migrations --interactive=0
call ../../yii migrate/down --migrationPath=@cmsgears/module-payment/migrations --interactive=0
call ../../yii migrate/down --migrationPath=@cmsgears/module-payment/migrations --interactive=0
