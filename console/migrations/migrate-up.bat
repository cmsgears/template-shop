...
call ../../yii migrate/up --migrationPath=@cmsgears/module-payment/migrations --interactive=0
call ../../yii migrate/up --migrationPath=@cmsgears/module-cart/migrations --interactive=0
...
call ../../yii migrate/up --migrationPath=@cmsgears/module-shop/migrations --interactive=0
call ../../yii migrate/up --migrationPath=@themes/shop/migrations --interactive=0
